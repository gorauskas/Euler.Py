...
EULER_STRING_MATRIX = '''08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
def get_grid(s):
    return [[int(x) for x in y] for y in [n.split() for n in s.split('\n')]]
